...
#Begin creating a list of movies to display.  The parameters taken are title, cast, plot, poster, trailer, release_year, and duration.
...
video_list = [toy_story, avatar, happy_gilmore, school_of_rock, ratatouille, midnight_in_paris]
